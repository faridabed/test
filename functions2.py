#PARTIE 2
import string
from functions import counter #pour la fonction calculate_question_tf_idf
import math
...
def calculate_question_tf_idf(question_tokens, unique_words, idf_scores):
    ...
    word_freq = counter(" ".join(question_tokens))#convertir les tokens en une seule chaine
